...
@section('content')
  <div class="section--top">
    <div class="section-left">
      <ul class="action-list">
          ...
          <li>
            <a onclick="cskAdmin.BootrstrapAlert.xdelete('admin/policy/delete', 'Group buy');return false;" class="delete-post btn btn-default">
  ...
  <script>
    $(function(){
      tableHelper.init("{{ URL::to('admin/policys') }}");
    })
  </script>
@stop