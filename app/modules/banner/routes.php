...
Route::group(array('before' => 'auth'), function(){
	...
	Route::any('admin/banner/create', 'App\Modules\Banner\BannerController@createAction')
		->before('pages_edit_permission');

	Route::any('admin/banner/{id}/edit', 'App\Modules\Banner\BannerController@editAction')
		->before('pages_edit_permission');
