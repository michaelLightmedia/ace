                ...
                <tbody>
                    <tr>
                        <td style="font-family: 'Helvetica', Arial, Sans-serif; font-size: 14px; color: #555555; line-height: 1.7;">
                            ...
                            <p style="margin: 0 0 35px 0; text-align: center;">Thank you for signing up with <strong style="color: #37a4ca;">Ace</strong> To Activate your accout please click the link below.</p>
                            <div style="text-align: center">
                                <a href="{{ URL::to('user/activate?code='.$code) }}" class="btn" style="display: inline-block; padding: 15px 28px; background: #35a5c7; color: #fff; border-radius: 4px; text-decoration: none; font-size: 16px;">Click here to activate</a>
                            </div>
                        </td>
                    </tr>
                </tbody>
