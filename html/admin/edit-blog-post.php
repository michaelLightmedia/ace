                    ...
                    <form class="form-inline form-rounded" role="form">
                        ...
                        <div class="dataTables_filter" id="sample_1_filter">
                            <div class="form-group">
                                ...
                                <input type="text" aria-controls="sample_1" class="form-control" id="exampleInputEmail2" placeholder="Search Blog Post..">
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="section section--offset">
                        <div class="row">
                            <div class="col-lg-9 col-md-8">
                                <div class="mb-15px">
                                    <input type="text" class="form-control form-control--2nd" placeholder="Blog Post Title">
                                </div>
                                <div class="panel">
