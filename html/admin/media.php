...
<?php include 'layouts/header.php'; ?>
		...
		<div class="section section--top">
				...
				<div class="pull-left">
					<a href="add-media.php" class="btn btn-blue btn-uc btn-sm-2nd mt-5px">
					...
					<form class="form-inline form-rounded" role="form">
						...
						<div class="dataTables_filter" id="sample_1_filter">
							<div class="form-group">
								...
								<input type="text" aria-controls="sample_1" class="form-control" placeholder="Search">
							</div>
						</div>
					</form>
				</div>
					...
					<table class="table table-pretty table-striped table-hover border-top" id="sample_1">
						<thead class="table-pretty-head">
							<tr>
								...
								<th>Image <a href="#"><i class="fa fa-sort"></i></a></th>
								<th>File <a href="#"><i class="fa fa-sort"></i></a></th>
								<th>Author <a href="#"><i class="fa fa-sort"></i></a></th>
								<th>Post Date <a href="#"><i class="fa fa-sort"></i></a></th>
							</tr>
						</thead>
						<tbody>
							<tr>
								...
								<td><a href="edit-media.php">1-120111024081832</a></td>
								<td>John Doe</td>
								<td>2013-11-18 00:55:48</td>
							</tr>
							<tr>
								<td><input type="checkbox" class="checkboxes" value="1" /></td>
								<td><img src="../../assets/global/placeholders/uploaded-featured.jpg" alt="" class="media-thumbnail--small"></td>
