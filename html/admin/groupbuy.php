...
<?php include 'layouts/header.php'; ?>
		...
		<div class="section section--top">
				...
				<div class="pull-left">
					<a href="edit-groupbuy.php" class="btn btn-blue btn-uc btn-sm-2nd mt-5px">
					...
					<form class="form-inline form-rounded" role="form">
						...
						<div class="dataTables_filter" id="sample_1_filter">
							<div class="form-group">
								...
								<input type="text" aria-controls="sample_1" class="form-control" id="exampleInputEmail2" placeholder="Search Group Buy..">
							</div>
						</div>
					</form>
				</div>
					...
					<table class="table table-pretty table-striped table-hover border-top" id="sample_1">
						<thead class="table-pretty-head">
							<tr>
								...
								<th>Price <a href="#"><i class="fa fa-sort"></i></a></th>
								<th>Sales Price <a href="#"><i class="fa fa-sort"></i></a></th>
								<th>Quantity <a href="#"><i class="fa fa-sort"></i></a></th>
								<th>Date Expire <a href="#"><i class="fa fa-sort"></i></a></th>
						...
						<tbody>
							<tr>
								...
								<td><a href="edit-groupbuy.php">Group Buy Title Here</a></td>
								<td>$123</td>
								<td>$123</td>
								<td>50</td>
								<td>12-12-13</td>
