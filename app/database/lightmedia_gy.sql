...
CREATE TABLE `gy_help_rates` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `taxable_income_from` int(11) unsigned DEFAULT NULL,
  `taxable_income_to` int(11) unsigned DEFAULT NULL,
  `repayment_rate` int(11) unsigned DEFAULT '0',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `gy_offset_rates` (
  ...
  `taxable_income_from` int(11) DEFAULT NULL,
  `taxable_income_to` int(11) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(8, 'single', 0, 84000, '2014-05-02 17:07:41', '2014-05-02 17:07:41'),
(9, 'single', 84001, 97000, '2014-05-02 17:10:00', '2014-05-02 17:10:00'),
(10, 'single', 97001, 130000, '2014-05-02 17:10:58', '2014-05-02 17:10:58'),
(11, 'single', 130001, 0, '2014-05-02 17:12:03', '2014-05-02 17:12:03'),
(12, 'family', 0, 168000, '2014-05-02 17:13:13', '2014-05-02 17:13:13'),
(13, 'family', 168001, 194000, '2014-05-02 17:14:36', '2014-05-02 17:14:36'),
(14, 'family', 194001, 260000, '2014-05-02 17:15:24', '2014-05-02 17:15:24'),
(15, 'family', 260001, 0, '2014-05-02 17:16:54', '2014-05-02 17:16:54');
...
(60, 12, 0, 65, 30, '2014-05-02 17:13:13', '2014-05-02 17:13:13'),
(61, 12, 65, 69, 35, '2014-05-02 17:13:13', '2014-05-02 17:13:13'),
(62, 12, 70, 0, 40, '2014-05-02 17:13:13', '2014-05-02 17:13:13'),
(63, 13, 0, 64, 20, '2014-05-02 17:14:36', '2014-05-02 17:14:36'),
(64, 13, 65, 69, 25, '2014-05-02 17:14:36', '2014-05-02 17:14:36'),
(65, 13, 70, 0, 30, '2014-05-02 17:14:36', '2014-05-02 17:14:36'),
(66, 14, 0, 64, 10, '2014-05-02 17:15:24', '2014-05-02 17:15:24'),
(67, 14, 65, 69, 15, '2014-05-02 17:15:24', '2014-05-02 17:15:24'),
(68, 14, 70, 0, 20, '2014-05-02 17:15:24', '2014-05-02 17:15:24'),
(69, 15, 0, 64, 0, '2014-05-02 17:16:54', '2014-05-02 17:16:54'),
(70, 15, 65, 69, 0, '2014-05-02 17:16:54', '2014-05-02 17:16:54'),
(71, 15, 70, 0, 0, '2014-05-02 17:16:54', '2014-05-02 17:16:54'),
(72, 8, 0, 64, 30, '2014-05-02 17:29:25', '2014-05-02 17:29:25'),
(73, 8, 65, 69, 35, '2014-05-02 17:29:25', '2014-05-02 17:29:25'),
(74, 8, 70, 0, 40, '2014-05-02 17:29:25', '2014-05-02 17:29:25'),
(78, 9, 0, 64, 20, '2014-05-02 17:29:46', '2014-05-02 17:29:46'),
(79, 9, 65, 69, 25, '2014-05-02 17:29:46', '2014-05-02 17:29:46'),
(80, 9, 70, 0, 30, '2014-05-02 17:29:46', '2014-05-02 17:29:46'),
(81, 10, 0, 64, 10, '2014-05-02 17:29:59', '2014-05-02 17:29:59'),
(82, 10, 65, 69, 15, '2014-05-02 17:29:59', '2014-05-02 17:29:59'),
(83, 10, 70, 0, 20, '2014-05-02 17:29:59', '2014-05-02 17:29:59'),
(84, 11, 0, 64, 0, '2014-05-02 17:30:18', '2014-05-02 17:30:18'),
(85, 11, 65, 69, 0, '2014-05-02 17:30:18', '2014-05-02 17:30:18'),
(86, 11, 70, 0, 0, '2014-05-02 17:30:18', '2014-05-02 17:30:18');
...
CREATE TABLE `gy_payments` (
  ...
  `total_amount_due` double(8,2) DEFAULT NULL,
...
CREATE TABLE `gy_tax_bank_interests` (
  ...
  `bank` varchar(255) DEFAULT NULL,
  `interest` int(11) unsigned DEFAULT NULL,
  `tax_withheld` int(11) unsigned DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `gy_tax_car_expenses` (
  ...
  `total_expenses` int(11) unsigned DEFAULT NULL,
  `business_percentage` tinyint(3) DEFAULT NULL,
  `car_purchase_date` date DEFAULT NULL,
  `car_purchase_amount` int(11) unsigned DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(46, 21, 6, 'SDF', 'Rotary 1.301L or Over', 75, 0, 1, 1232, 23, '2014-01-24', 123, '2014-05-02 18:23:32', '2014-05-02 18:23:32');

CREATE TABLE `gy_tax_dividends` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `user_tax_year_id` bigint(20) DEFAULT NULL,
  `company` varchar(64) DEFAULT NULL,
  `unfranked_divident` int(11) unsigned DEFAULT NULL,
  `franked_divident` int(11) unsigned DEFAULT NULL,
  `franking_credit` int(11) unsigned DEFAULT NULL,
  `tax_withheld` int(11) unsigned DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
...
(61, 21, 1, '392', '2014-05-02 18:53:22', '2014-05-02 18:53:22', NULL);
...
(8, NULL, 'family', 0, 168000, 0.00, '2014-03-31 22:09:17', '2014-05-02 16:12:18'),
...
CREATE TABLE `gy_tax_phi` (
  ...
  `australian_government_rebate` int(11) unsigned DEFAULT NULL,
  `premiums_paid` int(11) unsigned DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(66, 21, 'MBP - medicare Private', 'SDF', '30', 'MBP - medicare Private', 'A', 21232, 23232, '2014-05-02 18:53:22', '2014-05-02 18:53:22', NULL);
...
CREATE TABLE `gy_tax_rates` (
  ...
  `start_at` int(11) unsigned DEFAULT NULL,
  `cents_per_dollar` int(11) unsigned DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(9, 180001, 0, 1, 54547, 45, '2014-03-28 15:57:59', '2014-05-02 16:06:55');
...
CREATE TABLE `gy_tax_salary` (
  ...
  `gross_salary` int(11) unsigned DEFAULT NULL,
  `tax_withheld` int(11) unsigned DEFAULT NULL,
  `fringe_benefits` int(11) unsigned DEFAULT NULL,
  `allowance_amount` int(11) unsigned DEFAULT NULL,
  `lump_sum_amount` int(11) unsigned DEFAULT NULL,
...
(168, 21, '830041  432 39', 'Stephne', 50000, 10000, 3, 12, 0, 'R', '2014-05-02 19:31:17', '2014-05-02 19:31:17');
...
CREATE TABLE `gy_tax_zone_offsets` (
  ...
  `zone_a_amount` int(11) unsigned DEFAULT NULL,
  `zone_b_days` int(11) DEFAULT NULL,
  `zone_b_amount` int(11) unsigned DEFAULT NULL,
  `zone_x_days` int(11) DEFAULT NULL,
  `zone_x_amount` int(11) unsigned DEFAULT NULL,
  `zone_y_days` int(11) DEFAULT NULL,
  `zone_y_amount` int(11) unsigned DEFAULT NULL,
  `zone_z_days` int(11) DEFAULT NULL,
  `zone_z_amount` int(11) unsigned DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
(323, '$2y$08$qrt/84jYEJylRPkJ6qbjC.Xv9Th1dFV6GYsR8Gtte0/gQjQlVg5K.', 'michael1@lightmedia.com.au', 'stephen', 'cantila', 'M', NULL, '', NULL, '', '', '', NULL, 0.00, 0.00, NULL, '', NULL, '2014-03-30 18:32:50', '2014-03-30 18:32:50', NULL, 5, '5338d3d2742cd81be53dd90d9ff99cad426c04d972ab4', 0),
...
CREATE TABLE `gy_user_tax_years` (
  ...
  `status` varchar(64) DEFAULT NULL,
  `estimate_refund` int(11) DEFAULT NULL,
...
(12, 320, 2013, 'in_progress', 0, 'AUD', '2014-03-28 18:05:52', NULL, '2014-03-28 18:05:52'),
(13, 322, 2013, 'in_progress', 0, 'AUD', '2014-03-28 18:06:01', NULL, '2014-03-28 18:06:01'),
(14, 322, 2014, 'in_progress', 0, 'AUD', '2014-03-28 18:06:05', NULL, '2014-03-28 18:06:05'),
(15, 324, 2013, 'in_progress', 0, 'AUD', '2014-03-31 10:37:19', NULL, '2014-03-31 10:37:19'),
(16, 326, 2013, 'in_progress', 0, 'AUD', '2014-03-31 10:55:10', NULL, '2014-03-31 10:55:10'),
(17, 320, 2014, 'in_progress', 0, 'AUD', '2014-03-31 11:13:17', NULL, '2014-03-31 11:13:17'),
(18, 323, 2013, 'in_progress', 0, 'AUD', '2014-03-31 11:56:41', NULL, '2014-03-31 11:56:41'),
(19, 323, 2014, 'in_progress', 0, 'AUD', '2014-03-31 21:16:31', NULL, '2014-03-31 21:16:31'),
(20, 329, 2013, 'in_progress', 0, 'AUD', '2014-04-30 13:15:59', NULL, '2014-04-30 13:15:59'),
(21, 331, 2013, 'in_progress', 0, 'AUD', '2014-04-30 13:45:43', NULL, '2014-04-30 13:45:43'),
(22, 331, 2014, 'in_progress', 0, 'AUD', '2014-05-01 20:45:30', NULL, '2014-05-01 20:45:30');
