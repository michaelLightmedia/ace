...
k});var L,ga,Mc=0,Pa=q.ActiveXObject&&function(){for(var a in L)L[a](k,!0)};c.ajaxSettings._quick_validate_xhr=q.ActiveXObject?function(){var a;if(!(a=!this.isLocal&&lb()))a:{try{a=new q.ActiveXObject("Microsoft.XMLHTTP");break a}catch(b){}a=void 0}return a}:lb;ga=c.ajaxSettings._quick_validate_xhr();c.support.cors=!!ga&&"withCredentials"in ga;(ga=c.support.ajax=!!ga)&&c.ajaxTransport(function(a){if(!a.crossDomain||c.support.cors){var b;return{send:function(d,e){var f,g,h=a._quick_validate_xhr();if(a.username?h.open(a.type,a.url,a.async,a.username,
