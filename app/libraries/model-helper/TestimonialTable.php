...
class TestimonialTable  extends TableHelper
{
	private $query;
	private $table 	= "posts";
    ...
    public function column_post_title( $item ) 
    {
    	...
    	return sprintf(
            '<a href="testimonial/%s/edit">%s</a>
        	 <div class="row-actions">
	            <span class="edit">
	                <a href="testimonial/%s/edit" title="Edit this item">Edit</a> |
	            </span>
	            <span class="view">
	                <a href="%s" target="_blank" title="Delete " rel="permalink">View</a> | 
	            </span>
	            <span class="delete">
	                <a href="testimonial/delete?cid[]=%s" class="confirm-delete" title="Delete " rel="permalink">Delete</a>
	            </span>
	         </div>
