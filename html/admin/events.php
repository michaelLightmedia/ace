...
<?php include 'layouts/header.php'; ?>
		...
		<div class="section section--top">
				...
				<div class="pull-left">
					<a href="add-events.php" class="btn btn-blue btn-uc btn-sm-2nd mt-5px">
					...
					<form class="form-inline form-rounded" role="form">
						...
						<div class="dataTables_filter" id="sample_1_filter">
							<div class="form-group">
								...
								<input type="text" aria-controls="sample_1" class="form-control" id="exampleInputEmail2" placeholder="Search Events">
							</div>
						</div>
					</form>
				</div>
					...
					<table class="table table-pretty table-striped table-hover border-top" id="sample_1">
						<thead class="table-pretty-head">
							<tr>
								...
								<th>Time <a href="#"><i class="fa fa-sort"></i></a></th>
								<th>Venue <a href="#"><i class="fa fa-sort"></i></a></th>
						...
						<tbody>
							<tr>
								...
								<td><a href="#">Events Title Here</a></td>
								<td>12-5-2013</td>
								<td>1:30pm</td>
								<td>Suntec Room 1</td>
