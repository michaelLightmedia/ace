					...
					<div class="section section--offset">
						<div class="panel panel--offset">
							<ul class="nav nav-tabs nav-tabs--pretty">
								<li class="active"><a href="membership-details.php">Membership Details</a></li>
								...
								<div class="row">
									<div class="col-lg-7 col-md-7">
										<div class="mt-15px mb-15px form-horizontal l-fields-horizontal" role="form">
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Username</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="michaelivangonzales" disabled>
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Name</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="Michael Ivan Gonzales" disabled>
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">NRIC</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="SXXXXXXXXXXXX" disabled>
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Gender</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="Female">
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Birthday</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
											...
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Membership</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="Elite Gold" disabled>
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Loyalty Points</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="900" disabled>
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Date Joined</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="12-13-12" disabled>
												</div>
											</div>
										</div>
									</div>
									<div class="col-lg-2 col-lg-offset-3 col-md-5">
										<div class="row">
