					...
					<div class="section section--offset">
						<div class="panel panel--offset">
							<ul class="nav nav-tabs nav-tabs--pretty">
								...
								<li class="active"><a href="contact-details.php">Contact Details</a></li>
								...
								<div class="row">
									<div class="col-lg-8 col-md-8 col-sm-8">
										<div class="mt-15px mb-15px form-horizontal l-fields-horizontal" role="form">
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Email</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="michaelivangonzales@gmail.com">
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Mobile</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="123324-2343">
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Address 1</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="234 St. Lorem ipsum dolor sit amet, consectetur adipisicing">
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Address 2</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="234 St. Lorem ipsum dolor sit amet">
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Country</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<div class="selectpicker-full selectpicker-strict">
														<select class="selectpicker">
											...
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Post Code</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="Elite Gold">
												</div>
											</div>
											<div class="form-group">
												<label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Newsletter</label>
												<div class="col-lg-10 col-md-7 col-sm-7">
													<div class="selectpicker-full selectpicker-strict">
														<select class="selectpicker">
