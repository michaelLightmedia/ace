...
<div class="section section--top">
	...
	<div class="pull-left">
      <a href="{{ URL::to('admin/blog/create') }}" class="btn btn-blue btn-uc btn-sm-2nd mt-5px">
...
@section('content')
	...
	{{ Form::open(array('url' => 'admin/blog/'.$post['id'].'/edit', 'id' => 'post-form' )) }}
	{{ Form::hidden('post_type', 'blog') }}
	...
	{{ Form::hidden('guid', 'admin/blog/create') }}
	...
	<div class="section section--offset">
		<div class="row">
			<div class="col-lg-9 col-md-8">
				<div class="mb-15px">
					{{ Form::text('post_title', $post['post_title'], array('class' => 'form-control form-control--2nd validate[required]', 'placeholder' => 'Blog Title' )) }}
				</div>
				<div class="panel">
					{{ Form::textarea('post_content',$post['post_content'], array('class' => 'ckeditor form-control form-pretty')) }}
				</div>
			</div>
							...
							<div class="panel__content">
								<div class="row block--spread m-0px">
									<div class="col-lg-12">
										...
										<div class="form-group m-0px">
											{{ Form::textarea('meta[notes]', (isset($post['notes'])) ? $post['notes'] : null, array(
											'class' => 'form-control form-pretty',
