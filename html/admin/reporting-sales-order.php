...
<?php include 'layouts/header.php'; ?>
		...
		<div class="section section--top">
				...
				<div class="pull-right search">
					...
					<a href="reporting-sales-order.php" class="btn btn-default btn-default-blue mr-5px">
					...
					<table class="table table-pretty table-striped table-hover border-top" id="sample_1">
						<thead class="table-pretty-head">
							<tr>
								...
								<th>Orders <a href="#"><i class="fa fa-sort"></i></a></th>
						...
						<tbody>
							<tr>
								...
								<td><a href="orders-detail.php">#1232</a></td>
								<td>Order Name Here</td>
								<td>12-12-2013</td>
