...
class GroupTable  extends TableHelper
{
	private $query;
    ...
    {
    	return sprintf(
            '<a href="'.URL::to('admin/members/group/%d/edit').'">%s</a>', $item['id'], $item['group']
        );
    }
	...
	public function usort_reorder($a, $b)
	{
		...
		$orderby 	= (isset($_REQUEST['orderby']) && !empty($_REQUEST['orderby'])) ? $_REQUEST['orderby'] : 'group';
	...
	{	
		...
		$this->query = "SELECT * FROM ".DB::getTablePrefix()."groups as g WHERE 1=1 ";
		...
		$this->set_pagination_args( array(
			...
			'orderby'  		=> isset($_REQUEST['orderby']) ? $_REQUEST['orderby'] : 'group',
