                ...
                <tbody>
                    <tr>
                        <td style="font-family: 'Helvetica', Arial, Sans-serif; font-size: 14px; color: #555555; line-height: 1.7;">
                            <h1 style="margin-bottom: 15px; margin-top: 0; font-size: 26px; text-align: center; color: #333; ">You're account is almost <span style="color: #37a4ca;">ready!</span></h1>
                            <p style="text-align: center">
                                <img src="../../assets/site/i/placeholders/confirmation.png" alt="" style="display: inline-block; margin-top: 10px;">
                            </p>
                            <p style="margin: 0 0 35px 0; text-align: center;">Thank you for signing up with <strong style="color: #37a4ca;">ClearSK</strong> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi, omnis optio id accusantium voluptas quos assumenda sequi ratione cum cupiditate eaque provident quae officia error similique voluptatum amet ipsam suscipit? Officia.</p>
                            <div style="text-align: center">
                                <a href="#" class="btn" style="display: inline-block; padding: 15px 28px; background: #35a5c7; color: #fff; border-radius: 4px; text-decoration: none; font-size: 16px;">Click here to activate</a>
                            </div>
                        </td>
                    </tr>
                </tbody>
                ...
                <tbody>
                    <tr>
                        <td style="font-family: 'Helvetica', Arial, Sans-serif; font-size: 14px; color: #555555; line-height: 1.7; text-align: center;" valign="center">
                            <img src="../../assets/global/i/logo-gray.png" alt="">
                        </td>
                    </tr>
                </tbody>
            </table>
