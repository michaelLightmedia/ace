                    ...
                    <div class="section section--offset">
                        <div class="panel panel--offset">
                            <ul class="nav nav-tabs nav-tabs--pretty">
                                ...
                                <li class="active"><a href="points.php">Points</a></li>
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <div class="mt-15px mb-15px form-horizontal l-fields-horizontal" role="form">
                                            <div class="form-group">
                                                <label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Balance</label>
                                                <div class="col-lg-10 col-md-7 col-sm-7">
                                                    <input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="$2344" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Earned</label>
                                                <div class="col-lg-10 col-md-7 col-sm-7">
                                                    <input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="233" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Redeemed</label>
                                                <div class="col-lg-10 col-md-7 col-sm-7">
                                                    <input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="2343" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Referrals</label>
                                                <div class="col-lg-10 col-md-7 col-sm-7">
                                                    <input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="12">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Expiry</label>
                                                <div class="col-lg-10 col-md-7 col-sm-7">
                                                    <input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="12-12-13" disabled>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="" class="col-lg-2 col-md-5 col-sm-5 control-label">Total Balance</label>
                                                <div class="col-lg-10 col-md-7 col-sm-7">
                                                    <input type="text" class="form-control form-pretty form-pretty--white" id="" placeholder="$122334" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
