                ...
                <tbody>
                    <tr>
                        <td style="font-family: 'Helvetica', Arial, Sans-serif; font-size: 14px; color: #555555; line-height: 1.7;">
                            <h1 style="margin-bottom: 15px; margin-top: 0; font-size: 26px; text-align: center; color: #333; "><span style="color: #37a4ca;">Greate Deal</span> Shared with you!</h1>
                            <p style="margin: 0 0 35px 0; text-align: center;">{{ $ur_message }}</p>
                            <p style="margin: 0 0 35px 0; text-align: center;">Please click link below to avail greate deal.</p>
                            <div style="text-align: center">
                                <a href="{{ URL::to($url) }}" class="btn" style="display: inline-block; padding: 15px 28px; background: #35a5c7; color: #fff; border-radius: 4px; text-decoration: none; font-size: 16px;">Click here to avail</a>
                            </div>
                        </td>
                    </tr>
                </tbody>
