...
class TestimonialController extends \BaseController
{
	public function indexAction()
	{
		...
		{
		return \View::make('testimonial::index')
			->with('lists', $lists);
		}
	}
	...
	public function createAction()
	{
		...
		if($result['status'] == 'saved')
		{
			...
			return \Redirect::to('admin/testimonial/'.$post->id.'/edit');
		}
	...
	public function editAction( $id )
	{
		...
		if(!$post = \PPost::find($id))
		{
			return \Redirect::to('admin/testimonial')
				->with('error_msg', "Testimonial $id not found" );
		}
		...
		$arrayOfTerms = $terms->getArrayTerms('testimonial-category');
		$post_terms = $terms->getArrayPostTermTaxonomyId($id);
		
		


		return \View::make('testimonial::edit')
