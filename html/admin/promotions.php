		...
		<div class="section section--top">
				<div class="pull-left mr-15px">
					<h1 class="h3 section__title">
						<i class="fa fa-gift mr-5px"></i>
						<span>Promotions</span>
					</h1>
				</div>
				<div class="pull-left">
					<a href="add-promotions.php" class="btn btn-blue btn-uc btn-sm-2nd mt-5px">
					...
					<form class="form-inline form-rounded" role="form">
						...
						<div class="dataTables_filter" id="sample_1_filter">
							<div class="form-group">
								...
								<input type="text" aria-controls="sample_1" class="form-control" id="exampleInputEmail2" placeholder="Search Promotions">
							</div>
						</div>
					</form>
				</div>
					...
					<table class="table table-pretty table-striped table-hover border-top" id="sample_1">
						<thead class="table-pretty-head">
							<tr>
								...
								<th>Email Address <a href="#"><i class="fa fa-sort"></i></a></th>
								<th>Membership <a href="#"><i class="fa fa-sort"></i></a></th>
								<th>Points <a href="#"><i class="fa fa-sort"></i></a></th>
						...
						<tbody>
							<tr>
								...
								<td><a href="add-promotions.php">Promotions Here</a></td>
								<td><a href="#">janedoe@gmail.com</a></td>
