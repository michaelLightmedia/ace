...
@section('content')
		...
		<div class="col-lg-7">	
			{{ Form::open(array('url' => 'admin/members/group/'.$group['id'].'/edit')) }}
			{{ Form::hidden('id', $group['id']) }}
			<div class="mt-15px mb-15px form-horizontal l-fields-horizontal" role="form">
				<div class="form-group">
					{{ Form::label('group', 'Group Title', array('class' => 'col-lg-4 col-sm-4 control-label')) }}
					<div class="col-lg-8 col-md-7 col-sm-7">
						{{ Form::text('group', $group['group'], array('class' => 'form-control')) }}
					</div>
				</div>
				<div class="form-group">
