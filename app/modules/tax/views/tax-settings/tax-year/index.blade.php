...
<form action="" method="get" class="list--con">
    <div class="section section-l2">
        ...
        <div class="pull-left">
            <h1 class="h4 section-title">Medicare Levy Surcharge(MLS)</h1>    
        
            <a class="btn btn-blue btn-uc btn-sm-2nd mt-5px" href="{{ URL::to("/admin/tax-form/settings/tax-years/create") }}">
