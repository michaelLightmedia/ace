...
<?php include 'layouts/header.php'; ?>
		...
		<div class="section section--top">
				...
				<div class="pull-left">
					<a href="edit-blog-post.php" class="btn btn-blue btn-uc btn-sm-2nd mt-5px">
					...
					<form class="form-inline form-rounded" role="form">
						...
						<div class="dataTables_filter" id="sample_1_filter">
							<div class="form-group">
								...
								<input type="text" aria-controls="sample_1" class="form-control" id="exampleInputEmail2" placeholder="Search Blog">
							</div>
						</div>
					</form>
				</div>
					...
					<table class="table table-pretty table-striped table-hover border-top" id="sample_1">
						...
						<tbody>
							<tr>
								...
								<td><a href="edit-blog-post.php">Lorem ipsum dolor sit amet</a></td>
								<td>Uncategories</td>
								<td>12-5-2013</td>
								<td>2</td>
