                ...
                <tbody>
                    <tr>
                        <td style="font-family: 'Helvetica', Arial, Sans-serif; font-size: 14px; color: #555555; line-height: 1.7;">
                            ...
                            <p style="margin: 0 0 20px 0;"><strong>Dear {{ $customer_name }},</strong></p>

                            <p style="margin: 0 0 25px 0;">Thank you for your interest in Gytbo. Your order has been received and will be processed once payment has been confirmed.</p>
                            ...
                            <table width="100%" cellpadding="10" cellspacing="0" style="margin: 20px 0; text-align: left; border: 1px solid #eee;">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="20%" bgcolor="eeeeee">Sale Price</th>
                                        <th width="20%" bgcolor="eeeeee">Payout</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="border-right: 1px solid #eee; border-bottom: 1px solid #eee;" valign="top">
                                            {{ Gy::formatNumber($item['productPrice']) }}
                                        </td>
                                        <td style="border-right: 1px solid #eee; border-bottom: 1px solid #eee;" valign="top">
                                            {{ Gy::formatNumber($item['productSalePrice']) }}
                                        </td>
                                        <td style="border-right: 1px solid #eee; border-bottom: 1px solid #eee;" valign="top">
                                            {{ Gy::formatNumber($item['productPayout']) }}
                                        </td>
