...
class BaseEloquent extends Illuminate\Database\Eloquent\Model{
    /**
...
class HTML extends Illuminate\Support\Facades\HTML{
    ...
    /**
     * Obfuscate an e-mail address to prevent honeyLog-bots from sniffing it.
     *
     * @param string  $email
     * @return string
     * @static
    ...
    /**
     * Obfuscate a string to prevent honeyLog-bots from sniffing it.
     *
     * @param string  $value
     * @return string
     * @static
...
class $idsInput extends Illuminate\Support\Facades\Input{
    /**
