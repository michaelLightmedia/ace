...
@section('content')
	<div class="section section--top">
		<div class="section-left">
			<ul class="action-list">
				<li>
					<a href="{{ URL::to('admin/people/create') }}" class="btn btn-success">
	...
	{{ Form::open(array('url' => 'admin/people/'.$post['id'].'/edit', 'id' => 'post-form' )) }}
	{{ Form::hidden('post_type', 'people') }}
	...
	{{ Form::hidden('guid', 'admin/people/create') }}
	...
	<div class="section section--offset">
		<div class="row">
			<div class="col-lg-9 col-md-8">
				<div class="mb-15px">
					{{ Form::text('post_title', $post['post_title'], array('class' => 'form-control form-control--2nd validate[required]', 'placeholder' => 'People Title' )) }}
				</div>
				<div class="panel">
